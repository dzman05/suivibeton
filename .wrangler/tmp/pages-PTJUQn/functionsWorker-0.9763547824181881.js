...
async function onRequestGet2(context) {
  ...
  try {
    ...
    const mapped = results.map((r) => ({
      ...
      destination: ""
      // Not in schema yet? Add if needed or infer
    }));
    return new Response(JSON.stringify(mapped), { headers: { "Content-Type": "application/json" } });
  } catch (err) {
    return new Response(JSON.stringify({ error: err.message }), { status: 500 });
...
// ../.wrangler/tmp/pages-PTJUQn/functionsRoutes-0.10651745768211973.mjs
var routes = [
  {
...
// C:/Users/Cosider canalisation/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// C:/Users/Cosider canalisation/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
